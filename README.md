...
day15 [🌐](https://adventofcode.com/2021/day/15)[💾](./day15.py) | [![](./output/day15a.png)](./output/day15a.png) | 4/10 | Chiton #1 - Breadth first search with a twist - risk level means the processing queue needs to stay sorted by risk with each new entry
...
&nbsp;                                                            |  | 7/10 | Trick Shot #2 - The search space as a square of valid x and valid y values is huge,  1.1M simulations later (30 minutes) I had my second star but there has to be a better way.  Most of the search space can probably be eliminated before simulation...
