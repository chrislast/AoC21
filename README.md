...
.                                                                 | 1    | [![](./output/day9a2thumb.png)](./output/day9a2.png) |    |  contour map,  for science!
day9 [🌐](https://adventofcode.com/2021/day/9)[💾](./day9.py)    | 2    | [![](./output/day9bthumb.png)](./output/day9b.gif) | 4/10 |  used a breadth first search to fill each basin and return basin sizes, the animated gif behind the thumbnail takes *ages* if it ignores the 5ms frame duration!
