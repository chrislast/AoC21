...
&nbsp;                                                            |  | 4/10 | Extended Polymerization #2 - Switched to recursion to simplify problem and that still took >5minutes to not complete the first pair. After a rethink I realised caching the counter values for each letter pair at each level would speed things up by avoiding unnecessary recursion but I was amazed when the answer returned in less than 1/10th of a second 😮
