...
--- | ---- | ------------- | ---------- | -----
day1 [🌐](https://adventofcode.com/2021/day/1)[💾](./day1.py)    | both | ![](./output/day1.png)                             | 1/10 | 3 list generators and a sum to map the sea floor
day2 [🌐](https://adventofcode.com/2021/day/2)[💾](./day2.py)    | both | ![](./output/day2b.png)                            | 1/10 | parse text to move the submarine
...
day4 [🌐](https://adventofcode.com/2021/day/4)[💾](./day4.py)    | 1    | ![](./output/day4a.gif)                            | 4/10 | beat the squid at bingo using [x::n] slice notation for bingo card column check. Visualization is animated stack of all 100 cards (1 per row) as the colored numbers are removed
day4 [🌐](https://adventofcode.com/2021/day/4)[💾](./day4.py)    | 2    | ![](./output/day4b.gif)                            | 3/10 | lose to the squid instead. Visualization as part 1 but goes further in order to find last winner slight pause is where it restarts part2 with all numbers active again on same map
day5 [🌐](https://adventofcode.com/2021/day/5)[💾](./day5.py)    | 1    | [![](./output/day5athumb.png)](./output/day5a.png) | 2/10 | hydrothermal vent danger spots were easy to map using my 2d Map class which also handily provides the visualization
day5 [🌐](https://adventofcode.com/2021/day/5)[💾](./day5.py)    | 2    | [![](./output/day5bthumb.png)](./output/day5b.png) | 2/10 | improved the part one map drawing to create a single function with a tidier solution that supports diagonals
...
day6 [🌐](https://adventofcode.com/2021/day/6)[💾](./day6.py)    | 2    | [![](./output/day6bthumb.png)](./output/day6b.png) | 4/10 | you knew it was coming, brute force becomes impossible so forced to optimise.  Started by reasoning that collections.Counter population for one day 0 fish population after 16 days could be used 16 times for each day 0 fish to make 256 days then realised that applied all the way to 1 day where the only thing that needed "calculating" was new fish added to counter and update counter keys. O(n) for 256 days is *much* quicker (and simpler) than O(n²) for 80!
...
day7 [🌐](https://adventofcode.com/2021/day/7)[💾](./day7.py)    | 2    | [![](./output/day7bthumb.png)](./output/day7b.png) | 3/10 | possible to single step with guess and fuel calculate, slower but sure and good for graphing, solution is the turning point of quadratic curve graph so it's probably possible to calculate the formula directly and solve for the turning point
