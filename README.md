...
day9 [🌐](https://adventofcode.com/2021/day/9)[💾](./day9.py)    | [![](./output/day9a.png)](./output/day9a.png)   | 2/10 | Smoke Basin #1 - A fairly simple 2-D array accumulate results (risk) based on surrounding data (terrain) which might look nice if I change it to a pyplot contour map but doesn't look too bad just shaded in 2D
.                                                                 | [![](./output/day9a2.png)](./output/day9a2.png) |      | Smoke Basin #1 - contour map,  for science!
...
.                                                                 | [![](./output/day11b.gif)](./output/day11b.gif) | 2/10 | Dumbo Octopus #2 - thankfully it didn't take long to synchronize, so the only work was to refactor octopus updates in part1 solution for reuse in part 2
